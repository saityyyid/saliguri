      ...
      <div className="surface-card p-8">
        <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-slate-600">{villa.description ?? "Villa ini siap menyambut tamu dengan kenyamanan dan fasilitas lengkap."}</p>
          </div>
          <div className="rounded-[32px] bg-slate-50 p-6 text-right">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="aspect-[4/3] rounded-[32px] bg-[radial-gradient(circle_at_top_left,_rgba(45,80,22,0.15),_transparent_45%),_linear-gradient(180deg,_#edf5e6_0%,_#f9faf7_100%)]" />
              <div className="aspect-[4/3] rounded-[32px] bg-[radial-gradient(circle_at_top_left,_rgba(45,80,22,0.15),_transparent_45%),_linear-gradient(180deg,_#edf5e6_0%,_#f9faf7_100%)]" />
              <div className="aspect-[4/3] rounded-[32px] bg-[radial-gradient(circle_at_top_left,_rgba(45,80,22,0.15),_transparent_45%),_linear-gradient(180deg,_#edf5e6_0%,_#f9faf7_100%)]" />
              <div className="aspect-[4/3] rounded-[32px] bg-[radial-gradient(circle_at_top_left,_rgba(45,80,22,0.15),_transparent_45%),_linear-gradient(180deg,_#edf5e6_0%,_#f9faf7_100%)]" />
            </div>
            <div className="surface-card p-6 text-center">
              {villa.slug === "aula" ? (
                <>
                  ...
                  <p className="mt-3 text-slate-600">Hubungi admin untuk penawaran terbaik dan ketersediaan acara.</p>
                  <Link href="https://wa.me/6281368008800?text=Halo%20Saliguri%20Harau%20Cottage%2C%20saya%20ingin%20memesan%20Aula." className="mt-6 inline-flex items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#27480f]">
                    WhatsApp Admin
                  </Link>
                </>
              ) : (
                <Link href={`/booking?villa=${villa.slug}`} className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#27480f]">
